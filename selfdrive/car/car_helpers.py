...
from selfdrive.version import get_comma_remote, get_tested_branch, get_krk_remote, get_krk_branch
...
def get_startup_event(car_recognized, controller_available, fw_seen):
  if (get_comma_remote() and get_tested_branch()) or (get_krk_remote() and get_krk_branch()):
