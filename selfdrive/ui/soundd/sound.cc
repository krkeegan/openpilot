...
void Sound::update() {
  ...
  if (sm.updated("carState")) {
    ...
    float max_volume_scale = 0.8;  // KRKeegan percentage of default max volume
    volume = util::map_val(volume, 0.f, 1.f, Hardware::MIN_VOLUME, Hardware::MAX_VOLUME * max_volume_scale);
